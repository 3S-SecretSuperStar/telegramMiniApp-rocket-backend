...
export async function userInfo(req) {
  ...
  const outdata = await db.collection('users').find(query).project({ _id: 0, user_id: 1, name: 1, user_name: 1, gamesHistory: 1, balance: 1, referral: 1, ranking: 1, first_state: 1, task: 1, dailyHistory: 1, friend_count:1 }).toArray()[0]
